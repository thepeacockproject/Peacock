    ...
    peacock: {
        ...
        flags: {
            ...
            autoSplitterCampaign: {
                category: "Splitter",
                title: "autoSplitterCampaign",
                desc: "Which (main) campaign to use for the AutoSplitter. Can be set to 'hitman1', 'hitman2', 'hitman3', or 'trilogy'.",
                possibleValues: ["hitman1", "hitman2", "hitman3", "trilogy"],
                default: "trilogy",
            },
            autoSplitterRacetimegg: {
                category: "Splitter",
                title: "autoSplitterRacetimegg",
            ...
            autoSplitterForceSilentAssassin: {
                category: "Splitter",
                title: "autoSplitterForceSilentAssassin",
