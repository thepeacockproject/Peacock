...
/**
 * A contract's public ID as generated by Peacock's contract creation flow,
 * which always produces exactly 12 digits.
 */
export const publicIdRegex = /^\d{12}$/

/**
 * A public ID that is safe to interpolate into a file path.
 * In theory, it should always be 12 characters, but some of the Sapienza escalations seem to have 11.
 */
export const safePublicIdRegex = /^\d{1,32}$/
