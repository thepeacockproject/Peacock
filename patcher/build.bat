...
rem Linux - CLI
dotnet publish HitmanPatcher.CLI/HitmanPatcher.CLI.csproj -r linux -c "Release - Linux" -p:PublishSingleFile=True --no-self-contained -p DebugType=none -p:IsLinux=true -o Publish/Linux-Portable
