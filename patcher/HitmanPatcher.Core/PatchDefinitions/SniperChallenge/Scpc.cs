namespace HitmanPatcher.PatchDefinitions.SniperChallenge;

internal static class Scpc
{
    ...
    private static readonly HitmanVersion v1_0_1_h1_dx11_scpc = new()
    {
        certpin =
        [
    ...
    private static readonly HitmanVersion v1_0_1_h1_dx12_scpc = new()
    {
        certpin =
        [
